...
import { PLAN_PRICE, AUTHOR_HANDLE } from '../constants';
...
const LandingPage: React.FC<LandingPageProps> = ({ onStartTrial, onLogin }) => {
  return (
    <div className="min-h-screen bg-[#0f1115] font-sans selection:bg-emerald-500/30 text-white overflow-x-hidden">
      ...
      <nav className="fixed w-full top-0 z-50 border-b border-white/5 bg-[#0f1115]/80 backdrop-blur-xl transition-all">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <button onClick={onLogin} className="text-slate-400 hover:text-white font-medium text-sm hidden md:block transition-colors">
              Fazer Login
            </button>
            <button 
              onClick={onStartTrial}
              className="bg-white text-slate-950 px-6 py-2.5 rounded-full font-bold text-sm hover:bg-emerald-400 hover:text-white transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(16,185,129,0.4)]"
            >
              Testar Grátis
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-1.5 rounded-full text-emerald-400 font-mono text-xs uppercase tracking-widest shadow-lg backdrop-blur-md">
              ...
              IA Gemini 3 Pro • Atualizado 2025
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] tracking-tight">
              A Inteligência do Google <br/>
            ...
            <p className="text-lg md:text-xl text-slate-400 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Transformamos o suporte técnico em uma conversa. Diagnósticos, manuais e consultoria especializada sem sair do app que você já usa.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <button 
                onClick={onStartTrial}
                className="group relative bg-emerald-500 text-slate-950 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-emerald-400 transition-all shadow-[0_0_40px_rgba(16,185,129,0.3)] hover:scale-105"
              >
              ...
              <button 
                onClick={onLogin}
                className="bg-white/5 border border-white/10 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition-colors flex items-center justify-center gap-3 backdrop-blur-sm"
              >
            ...
            <div className="pt-8 flex items-center justify-center lg:justify-start gap-4 text-xs font-mono text-slate-500 uppercase tracking-widest">
                 <span>Midea</span> • <span>Samsung</span> • <span>LG</span> • <span>Gree</span> • <span>Daikin</span>
            </div>
          </div>
          ...
          <div className="relative mx-auto order-1 lg:order-2 perspective-1000">
             ...
             {/* THE PHONE CONTAINER - Floating Animation */}
             <div className="relative w-[320px] h-[680px] bg-slate-900 rounded-[55px] border-[6px] border-[#3f3f46] shadow-[0_0_0_2px_#52525b,0_20px_50px_-10px_rgba(0,0,0,0.5)] mx-auto overflow-hidden animate-float">
                {/* Dynamic Island */}
                ...
                <div className="w-full h-full bg-[#E5DDD5] rounded-[48px] overflow-hidden flex flex-col relative">
                     ...
                     {/* iOS Status Bar Mock */}
                     <div className="h-12 w-full flex justify-between items-center px-6 pt-2 text-black text-[10px] font-bold z-20">
                         <span>10:42</span>
                         <div className="flex gap-1">
                             <svg className="w-4 h-3" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
                     ...
                     <div className="bg-[#f4f4f4]/80 backdrop-blur-md border-b border-slate-200 px-4 py-2 flex items-center justify-between z-20 sticky top-0">
                         ...
                         <div className="flex flex-col items-center">
                             <div className="flex items-center gap-2">
                                 <div className="w-8 h-8 rounded-full bg-emerald-600 flex items-center justify-center text-white font-bold text-sm">Z</div>
                                 <div className="text-center">
                                     <h3 className="text-sm font-bold text-black leading-none">ZapPRO</h3>
                     ...
                     <div className="flex-1 p-3 space-y-3 overflow-hidden flex flex-col justify-end pb-4">
                         ...
                         <div className="flex justify-center mb-2">
                             <span className="bg-[#e2e8f0] text-slate-500 text-[10px] font-bold px-2 py-1 rounded shadow-sm">Hoje</span>
                         </div>

                         {/* User Message */}
                         <div className="flex justify-end">
                             <div className="bg-[#DCF8C5] p-3 rounded-2xl rounded-tr-sm shadow-sm max-w-[85%] relative">
                                 <p className="text-xs text-black leading-relaxed">
                                     Compressor Inverter Samsung não parte. Led pisca 3x.
                                 </p>
                                 <div className="text-[9px] text-slate-500 text-right mt-1 flex justify-end gap-1">
                                     10:42 <span className="text-[#34B7F1]">✓✓</span>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div className="flex justify-start">
                             <div className="bg-white p-3 rounded-2xl rounded-tl-sm shadow-sm max-w-[90%] relative">
                                 <p className="text-[10px] font-bold text-emerald-600 mb-1">ZapPRO IA</p>
                                 <p className="text-xs text-black leading-relaxed">
                                     Fala parceiro! 🛠️ Na Samsung, 3 piscadas é erro de **comunicação** ou **fase do compressor**.
                                 </p>
                                 <div className="mt-2 bg-slate-50 p-2 rounded border border-slate-100">
                                     ...
                                     <p className="text-[9px] text-slate-500">Áudio explicativo (0:45)</p>
                                 </div>
                                 <div className="flex gap-2 mt-2">
                                     <span className="bg-slate-100 text-slate-600 border border-slate-200 px-2 py-1 rounded-full text-[9px]">⚡ Teste IPM</span>
                                     <span className="bg-slate-100 text-slate-600 border border-slate-200 px-2 py-1 rounded-full text-[9px]">📘 Manual</span>
                                 </div>
                                 <div className="text-[9px] text-slate-500 text-right mt-1">10:42</div>
                             </div>
                         </div>
                     </div>

                     {/* Input Area (iOS Style) */}
                     <div className="bg-[#f6f6f6] px-3 py-3 flex items-center gap-3 border-t border-slate-200 z-20">
                         <svg className="w-6 h-6 text-[#007AFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
                         <div className="flex-1 bg-white border border-slate-200 rounded-full h-8 px-3 flex items-center">
                             <span className="text-xs text-slate-400">Mensagem</span>
                         </div>
                         <svg className="w-6 h-6 text-[#007AFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                         <svg className="w-6 h-6 text-[#007AFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /></svg>
                     </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px]">
             ...
             <div className="md:col-span-2 md:row-span-2 bg-[#18181b] rounded-3xl p-8 border border-white/5 relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
                 ...
                 <div className="relative z-10 h-full flex flex-col">
                     ...
                     <h3 className="text-2xl font-bold text-white mb-4">Gemini 3 Pro Inside</h3>
                     ...
                     <div className="mt-auto grid grid-cols-2 gap-3">
                         <div className="bg-black/40 p-4 rounded-xl border border-white/5">
                             <div className="text-emerald-400 font-mono text-xs mb-1">LATÊNCIA</div>
                             <div className="text-white font-bold text-xl">0.4s</div>
                         </div>
                         <div className="bg-black/40 p-4 rounded-xl border border-white/5">
                             <div className="text-emerald-400 font-mono text-xs mb-1">PRECISÃO</div>
             ...
             {/* Feature 4: Files */}
             <div className="md:col-span-2 md:row-span-1 bg-gradient-to-r from-emerald-900/40 to-[#18181b] rounded-3xl p-6 border border-white/5 flex items-center justify-between relative overflow-hidden">
                 <div className="relative z-10">
                     <h3 className="text-xl font-bold text-white mb-2">Manuais Ilimitados</h3>
                     <p className="text-sm text-slate-400 max-w-xs">Acesse a biblioteca técnica completa de Midea, LG, Samsung e Carrier instantaneamente.</p>
                 </div>
                 <div className="text-6xl opacity-20 grayscale saturate-0 animate-pulse">📚</div>
             </div>
          </div>
        </div>
      </section>
               ...
               <div className="bg-gradient-to-b from-[#1c1c21] to-[#131316] rounded-[40px] p-1 border border-white/10 shadow-2xl">
                   <div className="bg-[#18181b] rounded-[36px] p-8 md:p-16 text-center relative overflow-hidden">
                       ...
                       <div className="flex items-center justify-center gap-2 mb-10">
                           ...
                           <div className="text-left text-sm text-slate-500 leading-none">
                               <div>/mês</div>
                               <div>fatura mensal</div>
                           </div>
                       </div>

                       <div className="grid md:grid-cols-2 gap-4 mb-12 text-left max-w-lg mx-auto">
                           {['Consultas Ilimitadas', 'IA Gemini 3 Pro', 'Histórico na Nuvem', 'Suporte Prioritário'].map(f => (
                       ...
                       <button onClick={onLogin} className="w-full md:w-auto bg-white text-slate-950 px-12 py-4 rounded-xl font-bold text-lg hover:bg-emerald-400 transition-all shadow-lg hover:shadow-emerald-500/20">
                           Assinar Agora
                       </button>
      ...
      {/* --- FOOTER --- */}
      <footer className="py-12 border-t border-white/5 bg-[#0a0a0c] text-center text-slate-500 text-sm">
          <p className="mb-2">Feito para o campo 🇧🇷</p>
          <p>&copy; {new Date().getFullYear()} ZapPRO AI. Powered by Google Gemini.</p>
      </footer>
    </div>
  );
};
