...
export default function CheckoutSuccessPage() {
    ...
    useEffect(() => {
        // Simular verificação (webhook já deve ter processado)
            ...
            <div className="max-w-md w-full bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-8 border border-white/10">
                <div className="text-center">
                    ...
                    <p className="text-lg text-gray-300 mb-6">
                        Bem-vindo ao <span className="text-emerald-400 font-bold">ZapPRO</span>! 🎉
                    </p>

                    <div className="bg-black/20 rounded-xl p-6 mb-6 border border-white/5">
                        <p className="text-sm text-gray-400 mb-4">
                            Sua assinatura foi ativada com sucesso. Agora você tem acesso total a:
                        </p>
                        <ul className="text-left space-y-2 text-sm text-gray-300">
                            <li className="flex items-start gap-2">
                                <span className="text-emerald-400 mt-1">✓</span>
                                <span>Consultas ilimitadas com IA especializada</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-emerald-400 mt-1">✓</span>
                                <span>Acesso a mais de 100 manuais técnicos</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-emerald-400 mt-1">✓</span>
                                <span>Histórico de conversas na nuvem</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-emerald-400 mt-1">✓</span>
