  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0f1115] font-sans selection:bg-emerald-500/30 text-white overflow-x-hidden">
        ...
        <nav className="fixed w-full top-0 z-50 border-b border-white/5 bg-[#0f1115]/80 backdrop-blur-xl transition-all" role="navigation" aria-label="Principal">
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-6">
              <button aria-label="Fazer Login" onClick={handleLoginClick} className="text-slate-400 hover:text-white font-medium text-sm hidden md:block transition-colors">Fazer Login</button>
              <button aria-label="Testar Grátis" onClick={handleTrialClick} className="bg-white text-slate-950 px-6 py-2.5 rounded-full font-bold text-sm hover:bg-emerald-400 hover:text-white transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(16,185,129,0.4)]">Testar Grátis</button>
              <button aria-label="Assinar" onClick={handleSubscribeClick} className="text-slate-400 hover:text-white font-medium text-sm">Assinar</button>
            </div>
          </div>
        </nav>
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left space-y-8 order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                ...
                <button aria-label="Entrar com Google" onClick={handleLoginClick} className="bg-white/5 border border-white/10 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition-colors flex items-center justify-center gap-3 backdrop-blur-sm">
        ...
        <footer className="py-12 border-t border-white/5 bg-[#0a0a0c] text-center text-slate-500 text-sm"><p className="mb-2">Feito para o campo 🇧🇷</p><p>&copy; {new Date().getFullYear()} ZapPRO - Soluções para Ar-condicionado</p></footer>
      </div>
    </>
  )
}
